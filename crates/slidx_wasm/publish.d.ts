 ...
 * guess.
 */
export type DeckMetadata = { title?: string, description?: string, author?: string, 
/**
 ...
 */
export type DeckSource = { meta: DeckMetadata, slides: Array<DeckSlide>, artifacts: Array<Artifact>, };
...
export type PlanOptions = { meta: DeckMetadata, 
/**
 ...
 */
targets?: Array<PublishTarget>, social: SocialOptions, };

export type PublishPlan = { 
/**
 * The deck's title, or a stand-in, for the plan's header line.
 */
deck: string, steps: Array<PublishStep>, };

/**
 * One destination.
 */
export type PublishTarget = "speakerdeck" | "docswell" | "social" | "blog" | "resources" | "archive";

/**
 * A destination's own payload, which is what makes a ready step worth having.
 */
export type ReadyPayload = SpeakerDeckUpload | DocswellUpload | SocialPost | BlogScaffold | ResourcesPage | ArchiveRecord;
 ...
 */
export type SpeakerDeckUpload = { title: string, description: string, 
/**
 * Path segment under the author's profile.
 */
slug: string, tags: Array<string>, 
/**
...
export type DocswellUpload = { title: string, 
/**
...
export type SocialPost = { text: string, 
/**
 ...
 */
path: string, title: string, sections: Array<BlogSection>, 
/**
 ...
 */
export type BlogSection = { heading: string, 
/**
 ...
 */
links: Array<DeckLink>, markdown: string, };
 ...
 */
slug: string, path: string, title: string, event?: string, 
/**
 * ISO-8601, as authored. Kept as text so ordering never needs a clock.
 */
date?: string, venue?: string, author?: string, description?: string, 
/**
 ...
 */
recording?: string, repo?: string, tags: Array<string>, 
/**
 * What is not here *yet*, and when to come back for it.
 */
pending: Array<BlockedReason>, markdown: string, };
...
export type TalkIndex = { title: string, path: string, 
/**
 ...
 * fact.
 */
awaitingRecording: number, markdown: string, };
 ...
 */
export type PublishCall = { "op": "plan" } & PlanOptions | { "op": "formatPlan", plan: PublishPlan, } | { "op": "isReady", plan: PublishPlan, } | { "op": "composeSpeakerDeck" } & DeckSource | { "op": "composeDocswell" } & DeckSource | { "op": "composeSocial", source: DeckSource, options: SocialOptions, } | { "op": "composeBlog" } & DeckSource | { "op": "composeResources" } & DeckSource | { "op": "composeArchive" } & DeckSource | { "op": "describeSpeakerDeck", upload: SpeakerDeckUpload, } | { "op": "describeDocswell", upload: DocswellUpload, } | { "op": "describeSocial", post: SocialPost, } | { "op": "describeBlog", scaffold: BlogScaffold, } | { "op": "describeResources", page: ResourcesPage, } | { "op": "describeArchive", record: ArchiveRecord, } | { "op": "collectLinks" } & DeckSource | { "op": "buildTalkIndex", records: Array<ArchiveRecord>, options: TalkIndexOptions, } | { "op": "countCharacters", text: string, } | { "op": "truncate", text: string, limit: number, } | { "op": "asciiSlug", text: string, } | { "op": "fileSlug", text: string, } | { "op": "fitSlug", slug: string, limit: number, } | { "op": "normalizeTag", tag: string, } | { "op": "uniqueTags", tags: Array<string>, } | { "op": "tidyBlock", text: string, };
