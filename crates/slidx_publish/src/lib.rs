...
pub use targets::{
    ...
    compose_social, compose_speaker_deck, read_record, ArchiveRecord, BlogScaffold, BlogSection,
    CloudflarePages, DocswellUpload, ResourcesPage, SocialOptions, SocialPost, SpeakerDeckUpload,
    DEFAULT_POST_LIMIT,
};
pub use types::{
