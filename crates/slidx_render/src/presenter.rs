...
/// The presenter page's behaviour.
///
/// Written inline rather than bundled: it is a few lines of wiring around the
/// runtime, and inlining keeps the page working from a `file://` URL — which
