...
const PLUGIN: &str = "@slidxjs/vite-plugin";
...
mod tests {
    ...
    fn a_project_that_depends_on_the_plugin_says_so_through_its_manifest() {
        ...
        scratch
            .write("package.json", "{ \"devDependencies\": { \"@slidxjs/vite-plugin\": \"^0\" } }");
    ...
    fn a_project_that_registers_the_plugin_in_its_config_says_so_there() {
        ...
        scratch.write("vite.config.ts", "import { slidx } from \"@slidxjs/vite-plugin\";");
