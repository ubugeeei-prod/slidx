...
| ------- | -------------------------- | --------------- | ------------------------------------------ |
| Vue     | `@slidxjs/islands/vue`     | `vueIsland`     | `vue` and the Vue Vite plugin              |
| React   | `@slidxjs/islands/react`   | `reactIsland`   | `react`, `react-dom`, and the React plugin |
| Svelte  | `@slidxjs/islands/svelte`  | `svelteIsland`  | `svelte` and the Svelte Vite plugin        |
| Solid   | `@slidxjs/islands/solid`   | `solidIsland`   | `solid-js` and the Solid Vite plugin       |
| Angular | `@slidxjs/islands/angular` | `angularIsland` | Angular 20+ and its compiler plugin        |
